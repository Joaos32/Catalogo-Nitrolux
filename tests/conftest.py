...
def isolate_runtime_environment(monkeypatch, tmp_path):
    for env_key in (
        ...
        "CATALOG_MEDIA_BLOB_ENABLED",
        "CATALOG_MEDIA_BLOB_TOKEN",
        "CATALOG_MEDIA_BLOB_PREFIX",
        "CATALOG_MEDIA_CDN_BASE_URL",
        "CATALOG_MEDIA_MANIFEST_PATH",
        "CATALOG_ERP_JSON_PATH",
        "CATALOG_ERP_INBOX_DIR",
        "CATALOG_ERP_SOURCE_DIRS",
        "CATALOG_ERP_ADMIN_TOKEN",
        "CATALOG_INTEGRATION_API_KEY",
        "CATALOG_ALLOW_OPEN_ADMIN",
        "CATALOG_ADMIN_HOSTS",
        "CATALOG_REQUIRE_REPRESENTATIVE_LOGIN",
        ...
        "CATALOG_REPRESENTATIVE_S3_BUCKET",
        "CATALOG_REPRESENTATIVE_S3_KEY",
        "CATALOG_REPRESENTATIVE_S3_REGION",
        "CATALOG_REPRESENTATIVE_S3_ACCESS_KEY_ID",
        "CATALOG_REPRESENTATIVE_S3_SECRET_ACCESS_KEY",
        "CATALOG_REPRESENTATIVE_S3_ROLE_ARN",
        "CATALOG_REPRESENTATIVE_JWT_SECRET",
        "CATALOG_REPRESENTATIVE_JWT_EXPIRES_MINUTES",
        "CATALOG_REPRESENTATIVE_IDLE_TIMEOUT_MINUTES",
